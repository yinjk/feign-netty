...
//        }
//        feign.Response response = result.toFeignResponse();
////        System.out.println("return time: " + new Date().getTime());
//        System.out.println("=================+> get result: " + (new Date().getTime() - start.getTime()));
//        return response;
//    }
//
//    public abstract feign.Response doExecute(Client client, feign.Request request, feign.Request.Options options) throws IOException;
//    /**
