 ...
 */
//public class ProtoNettyClient implements Client {
//
//    //默认的http执行器
//    private Client httpClient = new Default(null, null);
//
//    /**
//     * logger
//     */
//    private static final Logger log = LoggerFactory.getLogger(ProtoNettyClient.class);
//
//    @Override
